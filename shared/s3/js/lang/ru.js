...
window._s3Lang['CONFIRM_CHANGING_PAGE_TYPE_OR_TEMPLATE'] = "Изменить тип/вид страницы?";
...
window._s3Lang['FIND_LOST_IMAGE_WARNING'] = "Предупреждение:<ul> <li>Потерянные иллюстрации будут восстановлены.</li> <li>Если на сайте имеются иллюстрации, которые не открываются (или отдают 404 ошибку) - ошибки будут исправлены, иллюстрации начнут отображаться корректно</li> <li>Аналогичные операции будут осуществлены с файлами (соответственно, в разделе «Файлы» потерянные и неоткрывающиеся файлы будут восстановлены)</li></ul>";
...
window._s3Lang['JS_BACKUP_MARKETPLACE_WARNING'] = "Обратите внимание! На версии сайта подключена интеграция с маркетплейсом. Откат сайта может вызвать ошибки в работе интеграции.";
...
window._s3Lang['JS_COORDINATES_ARE_INCORRECT'] = "Не корректно указаны координаты!";
